...
| `LLM_API_KEY` | — | ロケーション提案生成に使う LLM API キー（未設定時は提案生成をスキップ） |
| `LLM_API_URL` | `https://api.openai.com/v1/chat/completions` | LLM API エンドポイント |
...
| `LOCATION_LLM_CONFIG_PATH` | LLM の System/User Prompt と Response Schema を定義した JSON ファイルパス |
